...
import (
	...
	"com.amdatu.rti.deployment/Godeps/_workspace/src/k8s.io/kubernetes/pkg/api/unversioned" // Conversion error conveniently packages up errors in conversions.
	"com.amdatu.rti.deployment/Godeps/_workspace/src/k8s.io/kubernetes/pkg/conversion"
