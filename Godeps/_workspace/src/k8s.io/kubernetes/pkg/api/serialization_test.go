...
import (
	...
	"com.amdatu.rti.deployment/Godeps/_workspace/src/github.com/davecgh/go-spew/spew"
	flag "com.amdatu.rti.deployment/Godeps/_workspace/src/github.com/spf13/pflag"
	"com.amdatu.rti.deployment/Godeps/_workspace/src/k8s.io/kubernetes/pkg/api"
	"com.amdatu.rti.deployment/Godeps/_workspace/src/k8s.io/kubernetes/pkg/api/meta"
	"com.amdatu.rti.deployment/Godeps/_workspace/src/k8s.io/kubernetes/pkg/api/testapi"
	apitesting "com.amdatu.rti.deployment/Godeps/_workspace/src/k8s.io/kubernetes/pkg/api/testing"
	_ "com.amdatu.rti.deployment/Godeps/_workspace/src/k8s.io/kubernetes/pkg/apis/experimental"
	_ "com.amdatu.rti.deployment/Godeps/_workspace/src/k8s.io/kubernetes/pkg/apis/experimental/v1"
	"com.amdatu.rti.deployment/Godeps/_workspace/src/k8s.io/kubernetes/pkg/runtime"
	"com.amdatu.rti.deployment/Godeps/_workspace/src/k8s.io/kubernetes/pkg/util"
	"com.amdatu.rti.deployment/Godeps/_workspace/src/k8s.io/kubernetes/pkg/util/sets"
)
