...
import (
	...
	"com.amdatu.rti.deployment/Godeps/_workspace/src/k8s.io/kubernetes/pkg/api/latest"
	"com.amdatu.rti.deployment/Godeps/_workspace/src/k8s.io/kubernetes/pkg/api/meta"
	"com.amdatu.rti.deployment/Godeps/_workspace/src/k8s.io/kubernetes/pkg/api/registered"
	apiutil "com.amdatu.rti.deployment/Godeps/_workspace/src/k8s.io/kubernetes/pkg/api/util"
	_ "com.amdatu.rti.deployment/Godeps/_workspace/src/k8s.io/kubernetes/pkg/apis/experimental"
	"com.amdatu.rti.deployment/Godeps/_workspace/src/k8s.io/kubernetes/pkg/apis/experimental/v1"
