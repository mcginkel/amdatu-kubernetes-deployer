...
import (
	...
	apivalidation "com.amdatu.rti.deployment/Godeps/_workspace/src/k8s.io/kubernetes/pkg/api/validation"
	...
	errs "com.amdatu.rti.deployment/Godeps/_workspace/src/k8s.io/kubernetes/pkg/util/fielderrors"
	"com.amdatu.rti.deployment/Godeps/_workspace/src/k8s.io/kubernetes/pkg/util/sets"
	"com.amdatu.rti.deployment/Godeps/_workspace/src/k8s.io/kubernetes/pkg/util/validation"
)
